...
Title = Label(root, text="Random Password Generator", bg="black", fg="Orange", font=("futura", 15, "bold"))
Title.pack(anchor="center", pady="20px")

length = Label(root, text="Select the Length of Your Password :- ", fg="white", bg="black", font=("ubuntu", 12))
...
generate_btn = Button(root, text="Generate Password", bg="green", fg="white", font=("ubuntu", 15),bd=5, cursor="hand2", command=password_generate)
generate_btn.bind("<Enter>", on_enter)
generate_btn.bind("<Leave>", on_leave)
generate_btn.pack(anchor="center", pady="70px")

result_lable = Label(root, text="Generated Password Here :- ", bg="black", fg="white", font=("ubuntu", 12))
